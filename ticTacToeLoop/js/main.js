...
const changeCallNextMove = function(){
    callNextMove = true;
}

const reset = function(){
    setTimeout(changeCallNextMove, 300);
}
...
canvas.addEventListener('mousedown', function(evt) {
    ...
    if(evt.offsetX > 600 && evt.offsetX < 800 && evt.offsetY > 200 && evt.offsetY < 400 && drawPart === 2 && gameOver === true){
        restartGame();
    }

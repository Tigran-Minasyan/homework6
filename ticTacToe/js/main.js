...
const drawCord = function(location1, location2, isX){
    if(location1 === 0 && location2 === 0){
        drawMove(25,25,isX);
    }
    if(location1 === 0 && location2 === 1){
        drawMove(25,225,isX);
    }
    if(location1 === 0 && location2 === 2){
        drawMove(25,425,isX);
    }
    if(location1 === 1 && location2 === 0){
        drawMove(225,25,isX);
    }
